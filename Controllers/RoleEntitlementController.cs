...
using PikachuAI.Models;
using PikachuAI.Data;
using PikachuAI.Filter;
using PikachuAI.Entities;
using PikachuAI.Authorization;
using Microsoft.AspNetCore.Authorization;

namespace PikachuAI.Controllers
{
    /// <summary>
    ...
    {
        private readonly PikachuAIContext _context;

        public RoleEntitlementController(PikachuAIContext context)
        {
            _context = context;
        }
