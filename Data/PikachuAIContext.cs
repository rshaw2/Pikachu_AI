...
using PikachuAI.Entities;

namespace PikachuAI.Data
{
    public class PikachuAIContext : DbContext
    {
        protected override void OnConfiguring(Microsoft.EntityFrameworkCore.DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Data Source=codezen2.database.windows.net;Initial Catalog=T423798_Pikachu_AI;Persist Security Info=True;user id=test;password=PikachuAI@789;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
