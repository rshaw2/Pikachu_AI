...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "PikachuAI", Version = "v1" });
...
builder.Services.AddTransient<PikachuAIContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "PikachuAI API v1");
